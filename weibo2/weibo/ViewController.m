...
- (void)viewDidLoad {
    ...
    Weibo *weibo3 = [Weibo weiboWithIcon:@"03.jpg" name:@"彭宗阁" time:@"2018-02-02 23:32:33" source:@"来自iphone客户端" content:@"这是测试" img:@"01.jpg" vip:@"02.jpg"];
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Weibo *weibo =_weiboList[indexPath.row];
...
- (CGFloat) tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    f.weibo = _weiboList[indexPath.row];
    //NSLog(@"height==>%ld", f.cellHeight);
    return f.cellHeight;
}
